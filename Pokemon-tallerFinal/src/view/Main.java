...
public class Main extends PApplet {
	...
	public void draw() {
		...
		case 7:
			...
			fill(255);
			textSize(25);
			text("Para ordenar por nombre presionar la letra n, por fecha \n presionar la letra f ", 100, 100);
			text(reporte, 100, 200);
			image(time, 0, 0);
			break;
	...
	public void mousePressed() {
		...
		// llamar metodos de ordenamiento de usuario
	...
	public void keyPressed() {
		...
		// guarda el reporte de usuarios en un txt
		if (key == 'i') {

			saveStrings("data/reporte.txt", logica.guardarTxt());
		}
		// con k aparecen los usuarios que se han registrado
		if (key == 'k') {

			logica.probar();
		}
		// con f se ordena por fecha
		if (key == 'f') {

			logica.ordenarFecha();
			reporte = logica.reporteUsuarios();
		}
		// con n se ordena por nombre
		if (key == 'n') {
